...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "00d98cd92ade342fef589c0470379abb27baebe9"
  WORKING_DIRECTORY "D:/tensorflow/tensorflow/lite/tf_build/ml_dtypes"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/tensorflow/tensorflow/lite/tf_build/ml_dtypes'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/tensorflow/tensorflow/lite/tf_build/ml_dtypes'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
