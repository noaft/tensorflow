...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "90b73ac3f0b10320315c2ca0d03a5a9b095d2f66"
  WORKING_DIRECTORY "D:/tensorflow/tensorflow/lite/tf_build/protobuf"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/tensorflow/tensorflow/lite/tf_build/protobuf'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/tensorflow/tensorflow/lite/tf_build/protobuf'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
