...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "e6463926479bd6b330cbcf673f7e917803fd5831"
  WORKING_DIRECTORY "D:/tensorflow/tensorflow/lite/tf_build/flatbuffers"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/tensorflow/tensorflow/lite/tf_build/flatbuffers'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/tensorflow/tensorflow/lite/tf_build/flatbuffers'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
