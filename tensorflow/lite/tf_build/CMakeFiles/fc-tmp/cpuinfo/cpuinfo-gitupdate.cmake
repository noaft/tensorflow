...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "b73ae6ce38d5dd0b7fe46dbe0a4b5f4bab91c7ea"
  WORKING_DIRECTORY "D:/tensorflow/tensorflow/lite/tf_build/cpuinfo"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/tensorflow/tensorflow/lite/tf_build/cpuinfo'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/tensorflow/tensorflow/lite/tf_build/cpuinfo'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
